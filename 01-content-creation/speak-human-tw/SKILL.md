...
description: |
  ...
  觸發時機：用戶說「去 AI 味」「說人話」「幫說人話」「這段好 AI」「改自然一點」「幫我潤稿去掉 AI 感」「校對一下再發」「檢查是否有 AI 味」，或要求檢查電子報、社群貼文、銷售頁、課程文案、客服回信、簡報、公告、Email 等對外文字的語感。
...
changelog:
  - "1.5.0 (2026-08-15): 新增觸發詞「幫說人話」「檢查是否有 AI 味」，讓去 AI 味流程更容易自動命中。"
