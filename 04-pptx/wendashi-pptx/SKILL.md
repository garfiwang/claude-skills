...
name: wendashi-pptx
version: 2.0.0
description: '製作問大師家族辦公室（Wendashi Family Office）品牌簡報的專屬技能。 當使用者說「做問大師簡報」、「幫我做一份問大師的簡報」、「做一份信託簡報」、
  「做一份家族辦公室的簡報」、「做一份問大師風格的PPT」，或任何需要產出 符合問大師品牌識別系統 PPTX 的需求，一律使用此技能。 本技能（v2.0.0）包含全套「七大經典排版樣式」（封面目錄、問題過渡、雙欄對照、數據排行榜、三欄軸線矩陣、時間軸敘事、三步驟行動），
...
- version: 2.0.0
  date: '2026-07-05'
  note: 全面升級七大經典排版樣式、Logo 固定座標防遮擋與問大師品牌色系規範
- version: 1.0.0
  date: '2026-06-10'
  note: 初始版本
---
